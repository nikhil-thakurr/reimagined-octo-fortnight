            ...
            <div className='w-1/2 h-full'>
                ...
                <div className='w-full flex h-full'>
                    <div className='w-1/2 mt-10'>
                        ...
                        <ul className='underline'>Instagram</ul>
                        <ul className='underline'>Behance</ul>
                        <ul className='underline'>Facebook</ul>
                        <ul className='underline'>Linkedin</ul>

                        <h1 className='mt-10 mb-5'>L:</h1>
                        <ul className='underline'>202-1965 W 4th Ave</ul>
                        <ul className='underline'>Vancouver, Canada</ul>

                        <ul className='underline mt-5'>30 Chukarina St</ul>
                        <ul className='underline'>Lviv, Ukraine</ul>

                        <h1 className='mt-10 mb-5'>E:</h1>
                        <ul className='underline'>hello@nikhil.com</ul>

                        <div className='mt-12 text-gray-400 font-thin'>
                            © Nikhil design 2024. <span className='underline'>Legal Terms</span>
                        </div>
                    </div>

                    <div className='w-full flex justify-center items-center'>
                        <div className='w-1/2 ml-80 pt-60'>
                            <h1 className='mb-5'>M:</h1>
                            <ul className='underline'>Home</ul>
                            <ul className='underline'>Services</ul>
                            <ul className='underline'>Our Work</ul>
                            <ul className='underline'>About us</ul>
                            <ul className='underline'>Insights</ul>
                            <ul className='underline'>Contact us</ul>

                            <div className='mt-4 text-gray-400 font-thin'>
                                Website By Nikhil
                            </div>
                        </div>
                    </div>
