...
const LandingPage = () => {
  return (
    <div className="w-full h-screen font-['Founders_Grotesk_X-Condensed] ">
      ...
      <div className="border-t-2 mt-32 flex justify-between px-12 py-6 text-lg ">
        <div className="">For public and private companies</div>
        <div>From the first pitch to IPO</div>
        <div className="flex gap-2 items-center">
          <button className="rounded-3xl border-2 px-2 py-1 uppercase">
            Start The Project{" "}
          </button>
          <SlArrowRightCircle className="text-4xl -rotate-45" />
        </div>
      </div>
    </div>
  );
